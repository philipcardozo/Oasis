...
def build() -> dict[str, int]:
    ...
    for n in nodes:
        ...
        node_rows.append({
            ...
            "status": n.get("status"), "sec": n.get("sec"), "sector": n.get("sector"),
            "sub": n.get("sub"), "group": n.get("group"), "f": n.get("f"),
            "country": n.get("country"), "hq": n.get("hq"), "cik": n.get("cik"),
            "lei": n.get("lei"), "exchange": n.get("exchange"), "deg": n.get("deg"),
            "tot": n.get("tot"), "r": n.get("r"),
            ...
            "security_type_group": n.get("security_type_group"),
